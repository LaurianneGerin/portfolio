...
* Does this solution truly help the customer understand each step of an implementation?
...
* Number of self-served prospects pipeline
...
## Next steps
With more time, I would create a prototype that would be tested by real customers and collect as much feedback as possible from them and my designer peers before going through another iteration phase.
With what currently exists, the code and the design could be sufficient for a prototype and validate the potential of this onboarding educational game.
