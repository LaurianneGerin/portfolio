...
Impressed, I wanted to recreate the sabers with an extra interaction, when the mouse hovers the light saber it would flahs as if you were fighting with another light saber.

![Light sabers](./laser.png)

Recreating the saber the first step and then I watched in slowmotion a video of light sabers fights to understand the visual effects and saw the light explosion movement.
